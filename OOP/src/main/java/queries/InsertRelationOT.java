...
public class InsertRelationOT {
	...
	public static String createQuery(String strInsert, int startLineS, int startLineP) {
		...
		arrayRelationOT = RelationOrganizationTime.createRelationOT(RelationOrganizationTime.getJumpS(), startLineS, timeEntityCount, RelationOrganizationTime.getJumpP(), startLineP);// (number of subjects, starting line of the file containing information about subjects to be read, number of Time entity to be created, number of predicates, starting line of the file containing information about predicates to be read)
		strInsert = "";
